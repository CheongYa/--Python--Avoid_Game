...
# 배경 이미지 불러오기
background = pygame.image.load("D:\\Study\\Python_Study\\PythonWorkspace\\game\\avoid game\\background.png") # \\ 말고 / 로도 가능
...
# 적 enemy 캐릭터
enemy = pygame.image.load("D:\\Study\\Python_Study\\PythonWorkspace\\game\\avoid game\\enemy.png")
