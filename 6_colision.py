...
# 배경 이미지 불러오기
background = pygame.image.load("D:\\Study\\PythonWorkspace\\game\\avoid game\\background.png")
# \\ 말고 / 로도 가능

# 스프라이트(캐릭터) 불러오기
character = pygame.image.load("D:\\Study\\PythonWorkspace\\game\\avoid game\\character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("D:\\Study\\PythonWorkspace\\game\\avoid game\\enemy.png")
